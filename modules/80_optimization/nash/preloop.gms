...
if((cm_emiscen ne 1) and (cm_emiscen ne 9) and(cm_emiscen ne 10) and (smax(t,pm_pvp(t,"perm"))) eq 0,
 loop(ttot$(ttot.val ge 2005),
...
if((cm_emiscen eq 1) or (cm_emiscen eq 9) or (cm_emiscen eq 10), !! if there is no period trade, set the price to zero.
    pm_pvp(ttot,"perm")=0;
);
