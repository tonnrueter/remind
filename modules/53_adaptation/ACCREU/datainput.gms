...
*** SOF ./modules/53_adaptation/ACCREU/datainput.gms
...
v53_protectSLR.l(ttot,regi) = 0;
v53_costProtectSLR.l(ttot,regi) = 0;

p53_SLRadapt1(regi) = 0.87861;
p53_SLRadapt2(regi) = 0.30409257;

pm_GDPGross(tall,regi) = 0;
$endif.SLR


*** EOF ./modules/53_adaptation/ACCREU/datainput.gms
