...
*** SOF ./modules/51_internalizeDamages/COACCHitr/declarations.gms
...
p51_scc_regi(tall,all_regi) "Social cost of carbon (due to GDP damages) [$ per tCO2eq]"
p51_scc_regi_int(tall,all_regi) "Social cost of carbon (due to GDP damages) [$ per tCO2eq]"
...
*** EOF ./modules/51_internalizeDamages/COACCHitr/declarations.gms
